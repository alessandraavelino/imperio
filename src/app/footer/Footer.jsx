    ...
    <div>
        <footer className="text-gray-600 justify-center body-font" id="footer">
            ...
            <div className="bg-gray-100">
                ...
                <p className="text-gray-500 text-md text-center md:text-left">© 2024 Todos os direitos reservados —
                    <a href="#footer" rel="noopener noreferrer" className="text-[#001E5F] ml-1">Império Pet</a>
                </p>
