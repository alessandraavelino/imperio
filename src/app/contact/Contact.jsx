...
function Contact() {
  return (
    <div>
        <section className="font-semibold bg-[#FFCC00] body-font relative">
            <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                    ...
                    <div className="lg:w-1/2 px-6">
                        ...
                        <p className="mt-1">R. Otacílio Líra Cabral, 100 - Areia Branca, Guarabira - PB, 58200-000</p>
                    </div>
                ...
                <p className="leading-relaxed mb-5 text-[#001E5F]">Faremos o possível para responder o mais rápido!</p>
                ...
                <button className="text-white bg-[#001E5F] border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Enviar</button>
                </div>
            </div>
            </section>
    </div>
