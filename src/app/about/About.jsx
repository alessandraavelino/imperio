        ...
        <section className="text-gray-600 body-font" id="about">
            <div className="container px-5 py-24 mx-auto">
                ...
                <div className="w-20 h-20 inline-flex items-center justify-center bg-[#001E5F] text-[#001E5F] mb-5 flex-shrink-0 rounded-full overflow-hidden">
                    <Image src="https://images.unsplash.com/photo-1532202802379-df93d543bac3?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Logotipo da Império Pet"/>
                </div>
                ...
                <div className="w-20 h-20 inline-flex items-center justify-center bg-indigo-100 text-[#001E5F] mb-5 flex-shrink-0 rounded-full overflow-hidden">
                    <Image src="https://images.unsplash.com/photo-1591946614720-90a587da4a36?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Logotipo da Império Pet"/>
                </div>
                    <div className="flex-grow">
                ...
                <div className="w-20 h-20 inline-flex items-center justify-center bg-indigo-100 text-indigo-500 mb-5 flex-shrink-0 rounded-full overflow-hidden">
                    <Image src="https://images.unsplash.com/photo-1415369629372-26f2fe60c467?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Logotipo da Império Pet"/>
                </div>
                    <div className="flex-grow">
